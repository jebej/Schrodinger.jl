...
@inbounds revtuple{N}(t::NTuple{N,Any}) = ntuple(i->t[N+1-i],Val{N})
@inbounds revinds{N}(t::NTuple{N,Any},ns::Int) = ntuple(i->ns+1-t[N+1-i],Val{N})
@inbounds gettuple{N}(t1::NTuple,t2::NTuple{N,Any}) = ntuple(i->t1[t2[i]],Val{N})
